  ...
  <div class="flex items-center justify-center">
    ...
    <div v-else class="bg-app-bg0 p-3 rounded-[6px] w-full">
      <div class="flex flex-col items-center justify-center">
        <div class="row-center bg-app-bg2 p-4 rounded-[12px] w-full justify-between">
          <p class="text-[20px] md:text-[24px] font-[600]">{{ route.amountInFloat }} {{ inputToken?.symbol }}</p>
        ...
        <div class="row-center bg-app-bg2 p-4 mt-3 rounded-[12px] w-full justify-between">
          <p class="text-[20px] md:text-[24px] font-[600]">{{ formatNumber(route.amountOutFloat) }} {{ outputToken?.symbol }}</p>
          <div class="w-[30px] md:w-[40px] rounded-full overflow-hidden">
