      ...
      <CollapsibleTrigger class="w-full">
        <div class="row-center w-full justify-between text-[12px] p-3">
          <div class="row-center text-app-text3">
            ...
            <p class="ml-1 text-start">BNB needed to create {{ position }} positions: {{ totalFee.toFixed(5) }} BNB</p>
          </div>
      ...
      <CollapsibleContent class="border-t border-t-app-line2 p-3 space-y-3 text-app-text1">
        ...
        <div>
          ...
          <div class="row-center">
            <p>{{ position }} x 0.06 BNB = {{ position * 0.06 }} BNB</p>
        ...
        <div>
          ...
          <div class="row-center">
            <p>{{ positionInfo?.binArraysCount || 0 }} x 0.07 BNB = {{ (positionInfo?.binArraysCount || 0) * 0.07 }} BNB</p>
        ...
        <div>
          ...
          <p>{{ position }} x 0.00005 BNB = {{ formatNumber(position * 0.00005) }} BNB</p>
        </div>
      </CollapsibleContent>
    </Collapsible>
    <div v-if="portfolio.balance < 0.07" class="px-2 py-3 rounded-[8px] bg-app-cardWarning">
      We recommend keeping at least 0.07 BNB for any transaction.
    </div>
